...
/**
 * Event emitted when a delegated-account authorisation is updated.
 *
...
final class delegation_updated extends \core\event\base {
    ...
    public static function get_name(): string {
        return get_string('eventdelegationupdated', 'local_delegateaccount');
    }
    ...
    public function get_description(): string {
        return "The user with id '{$this->userid}' updated a delegation for the user with id " .
