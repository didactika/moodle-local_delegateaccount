...
/**
 * Event emitted when a delegated-account authorisation is created.
 *
...
final class delegation_created extends \core\event\base {
    ...
    public static function get_name(): string {
        return get_string('eventdelegationcreated', 'local_delegateaccount');
    }
    ...
    public function get_description(): string {
        return "The user with id '{$this->userid}' created a delegation for the user with id " .
