...
$string['notificationtemplate_desc'] = 'Modèle pour cette langue. Espaces réservés disponibles : {$a->authoriseduser}, {$a->delegateduser}, {$a->actor}, {$a->timestart}, {$a->timeend}, {$a->sitefullname}.';
$string['notificationtemplatedefault'] = 'Vous disposez d’une relation de compte délégué sur {$a->sitefullname}. Utilisateur autorisé : {$a->authoriseduser}. Compte délégué : {$a->delegateduser}. Configurée par : {$a->actor}. Début de l’accès : {$a->timestart}. Fin de l’accès : {$a->timeend}.';
...
$string['delegationnotificationsubject'] = 'Accès au compte délégué';
