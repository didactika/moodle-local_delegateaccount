...
$string['activity_filter_action'] = 'L\'action contient';
$string['activity_filter_component'] = 'Le composant contient';
$string['activity_filter_datefrom'] = 'Depuis';
$string['activity_filter_dateto'] = 'Jusqu\'à';
$string['activity_filter_invalidperiod'] = 'La fin de la période doit être postérieure à son début.';
...
$string['confirm_revoke_bulk'] = 'Voulez-vous vraiment révoquer les délégations sélectionnées ?';
$string['confirm_revoke_single'] = 'Voulez-vous vraiment révoquer cette délégation ?';
$string['confirm_revoke_title'] = 'Confirmer la révocation';
...
$string['delegated_accounts_menu'] = 'Comptes délégués';
$string['delegated_activity_description'] = 'Ce rapport présente les événements enregistrés par Moodle pendant que {$a->authoriseduser} utilisait le compte délégué {$a->delegateduser}, du {$a->timestart} au {$a->timeend}. Le magasin de journaux du site reste la source de référence.';
...
$string['delegation_search'] = 'Rechercher des comptes délégués';
...
$string['delegations_revoked_success'] = 'Délégations révoquées : {$a}.';
$string['delegations_updated_success'] = 'Délégations mises à jour : {$a}.';
...
$string['edit_selected_delegations'] = 'Modifier la sélection';
...
$string['my_delegated_accounts'] = 'Mes comptes délégués';
$string['my_delegated_accounts_description'] = 'Cette page répertorie tous les comptes actifs qui vous sont actuellement délégués. Sélectionnez un compte pour démarrer une session déléguée protégée.';
...
$string['revoke_selected'] = 'Révoquer la sélection';
$string['scheduled_delegations'] = 'Délégations planifiées';
$string['search_authorised_users'] = 'Rechercher des utilisateurs autorisés';
$string['select_all_delegations'] = 'Sélectionner toutes les délégations révocables de cette page';
$string['select_delegation'] = 'Sélectionner la délégation de {$a}';
...
$string['use_delegated_account'] = 'Utiliser le compte délégué : {$a}';
...
$string['view_all_delegated_accounts'] = 'Afficher tous les comptes délégués';
