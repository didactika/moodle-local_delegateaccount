...
$string['activity_filter_action'] = 'A ação contém';
$string['activity_filter_component'] = 'O componente contém';
$string['activity_filter_datefrom'] = 'Desde';
$string['activity_filter_dateto'] = 'Até';
$string['activity_filter_invalidperiod'] = 'O fim do período deve ser posterior ao início.';
...
$string['delegated_accounts_menu'] = 'Contas delegadas';
...
$string['delegations_updated_success'] = 'Delegações atualizadas: {$a}.';
...
$string['edit_selected_delegations'] = 'Editar selecionadas';
...
$string['my_delegated_accounts'] = 'As minhas contas delegadas';
$string['my_delegated_accounts_description'] = 'Esta página apresenta todas as contas ativas atualmente delegadas a si. Selecione uma conta para iniciar uma sessão delegada protegida.';
...
$string['view_all_delegated_accounts'] = 'Ver todas as contas delegadas';
