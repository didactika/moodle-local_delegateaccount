...
$string['delegated_activity_description'] = 'Este relatório apresenta os eventos registados pelo Moodle enquanto {$a->authoriseduser} utilizava a conta delegada {$a->delegateduser}. O armazenamento de registos do site continua a ser a fonte de referência.';
