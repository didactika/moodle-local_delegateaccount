...
$string['activity_filter_action'] = 'La acción contiene';
$string['activity_filter_component'] = 'El componente contiene';
$string['activity_filter_datefrom'] = 'Desde';
$string['activity_filter_dateto'] = 'Hasta';
$string['activity_filter_invalidperiod'] = 'El final del periodo debe ser posterior a su inicio.';
...
$string['authoriseduser'] = 'Persona autorizada';
...
$string['confirm_revoke_bulk'] = '¿Seguro que desea revocar las delegaciones seleccionadas?';
$string['confirm_revoke_single'] = '¿Seguro que desea revocar esta delegación?';
$string['confirm_revoke_title'] = 'Confirmar revocación';
...
$string['delegated_accounts_menu'] = 'Cuentas delegadas';
$string['delegated_activity_description'] = 'Este informe muestra los eventos que Moodle registró mientras {$a->authoriseduser} utilizaba la cuenta delegada {$a->delegateduser}, desde {$a->timestart} hasta {$a->timeend}. El almacén de registros del sitio sigue siendo la fuente de referencia.';
...
$string['delegation_filter_none'] = 'Sin registros de delegación';
$string['delegation_filter_user'] = 'Datos de usuario';
...
$string['delegation_search'] = 'Buscar cuentas delegadas';
...
$string['delegation_updated_success'] = 'La delegación se ha actualizado correctamente.';
...
$string['delegations_revoked_success'] = 'Delegaciones revocadas: {$a}.';
$string['delegations_updated_success'] = 'Delegaciones actualizadas: {$a}.';
$string['delegations_user_not_authorised'] = 'Este usuario ya no tiene permiso para usar cuentas delegadas. Su historial de delegaciones sigue disponible para consulta, pero no se pueden crear nuevas delegaciones.';
$string['delete_selected'] = 'Eliminar las seleccionadas';
$string['deleted_success'] = 'La delegación se ha eliminado correctamente.';
$string['edit_delegation'] = 'Editar delegación';
$string['edit_selected_delegations'] = 'Editar seleccionadas';
...
$string['error_unauthorised_realuser'] = 'Cada usuario autorizado debe tener actualmente permiso para usar cuentas delegadas.';
...
$string['manage_authorised_users'] = 'Usuarios autorizados';
$string['manage_authorised_users_description'] = 'Todos los usuarios activos que actualmente tienen permiso para usar cuentas delegadas, incluidos quienes aún no tienen ninguna delegación.';
$string['manage_historical_users'] = 'Usuarios sin permiso';
$string['manage_historical_users_description'] = 'Usuarios que conservan registros de delegaciones pero ya no tienen permiso para usar cuentas delegadas. Su historial e informes de actividad siguen disponibles para consulta.';
...
$string['my_delegated_accounts'] = 'Mis cuentas delegadas';
$string['my_delegated_accounts_description'] = 'Esta página muestra todas las cuentas activas que tiene delegadas actualmente. Seleccione una cuenta para iniciar una sesión delegada protegida.';
...
$string['revoke_selected'] = 'Revocar seleccionadas';
$string['scheduled_delegations'] = 'Delegaciones programadas';
$string['search_authorised_users'] = 'Buscar usuarios autorizados';
$string['select_all_delegations'] = 'Seleccionar todas las delegaciones revocables de esta página';
$string['select_delegation'] = 'Seleccionar la delegación de {$a}';
...
$string['use_delegated_account'] = 'Usar cuenta delegada: {$a}';
...
$string['view_all_delegated_accounts'] = 'Ver todas las cuentas delegadas';
