...
$string['notificationtemplate_desc'] = 'Plantilla para este idioma. Variables disponibles: {$a->authoriseduser}, {$a->delegateduser}, {$a->actor}, {$a->timestart}, {$a->timeend}, {$a->sitefullname}.';
$string['notificationtemplatedefault'] = 'Tienes una relación de cuenta delegada en {$a->sitefullname}. Usuario autorizado: {$a->authoriseduser}. Cuenta delegada: {$a->delegateduser}. Configurada por: {$a->actor}. El acceso comienza: {$a->timestart}. El acceso finaliza: {$a->timeend}.';
...
$string['delegationnotificationsubject'] = 'Acceso a cuenta delegada';
