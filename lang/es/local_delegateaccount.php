...
$string['delegated_activity_description'] = 'Este informe muestra los eventos que Moodle registró mientras {$a->authoriseduser} utilizaba la cuenta delegada {$a->delegateduser}. El almacén de registros del sitio sigue siendo la fuente de referencia.';
