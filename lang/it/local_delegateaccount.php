...
$string['notificationtemplate_desc'] = 'Modello per questa lingua. Segnaposto disponibili: {$a->authoriseduser}, {$a->delegateduser}, {$a->actor}, {$a->timestart}, {$a->timeend}, {$a->sitefullname}.';
$string['notificationtemplatedefault'] = 'Hai una relazione di account delegato in {$a->sitefullname}. Utente autorizzato: {$a->authoriseduser}. Account delegato: {$a->delegateduser}. Configurata da: {$a->actor}. L’accesso inizia: {$a->timestart}. L’accesso termina: {$a->timeend}.';
...
$string['delegationnotificationsubject'] = 'Accesso all’account delegato';
