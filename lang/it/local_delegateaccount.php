...
$string['delegated_activity_description'] = 'Questo rapporto mostra gli eventi registrati da Moodle mentre {$a->authoriseduser} utilizzava l\'account delegato {$a->delegateduser}. L\'archivio dei log del sito rimane la fonte di riferimento.';
