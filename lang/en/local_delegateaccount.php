...
$string['activity_component'] = 'Component';
$string['activity_event'] = 'Event';
$string['activity_filter_action'] = 'Action contains';
$string['activity_filter_component'] = 'Component contains';
$string['activity_filter_datefrom'] = 'From';
$string['activity_filter_dateto'] = 'Until';
$string['activity_filter_invalidperiod'] = 'The end of the period must be later than its start.';
$string['activity_target'] = 'Target';
$string['activity_time'] = 'Time';
...
$string['authoriseduser'] = 'Authorised user';
...
$string['confirm_revoke_bulk'] = 'Are you sure you want to revoke the selected delegations?';
$string['confirm_revoke_single'] = 'Are you sure you want to revoke this delegation?';
$string['confirm_revoke_title'] = 'Confirm revocation';
...
$string['delegated_accounts_menu'] = 'Delegated accounts';
$string['delegated_activity_description'] = 'This report shows events recorded by Moodle while {$a->authoriseduser} used the delegated account {$a->delegateduser}, from {$a->timestart} to {$a->timeend}. The site log store remains the source of record.';
$string['delegated_activity_for'] = 'Delegated activity: {$a->authoriseduser} as {$a->delegateduser}';
...
$string['delegation_created'] = 'Created';
$string['delegation_created_by'] = 'Created by';
$string['delegation_details'] = 'Delegation details';
$string['delegation_end'] = 'Access ends';
$string['delegation_filter_none'] = 'No delegation records';
$string['delegation_filter_user'] = 'User details';
$string['delegation_modified'] = 'Last modified';
$string['delegation_modified_by'] = 'Last modified by';
$string['delegation_no_end'] = 'No end date';
$string['delegation_revoked'] = 'Revoked';
$string['delegation_revoked_by'] = 'Revoked by';
$string['delegation_search'] = 'Search delegated accounts';
...
$string['delegation_unknown_user'] = 'Deleted user';
$string['delegation_updated_success'] = 'The delegation has been updated successfully.';
$string['delegationnotificationmode'] = 'Notify affected users';
$string['delegationnotificationmode_always'] = 'Send a notification';
$string['delegationnotificationmode_desc'] = 'Choose whether this delegation sends a notification to the affected users.';
$string['delegationnotificationmode_help'] = 'Choose whether this operation sends a notification to the affected users. This option appears only when the site policy permits a choice.';
$string['delegationnotificationmode_never'] = 'Do not send a notification';
...
$string['delegations_revoked_success'] = 'Delegations revoked: {$a}.';
$string['delegations_updated_success'] = 'Delegations updated: {$a}.';
$string['delegations_user_not_authorised'] = 'This user no longer has permission to use delegated accounts. Their existing delegation history remains available for review, but no new delegation can be created.';
$string['delete_selected'] = 'Delete selected';
$string['deleted_success'] = 'The delegation has been removed successfully.';
$string['edit_delegation'] = 'Edit delegation';
$string['edit_selected_delegations'] = 'Edit selected';
...
$string['error_unauthorised_realuser'] = 'Each authorised user must currently have permission to use delegated accounts.';
...
$string['manage_authorised_users'] = 'Authorised users';
$string['manage_authorised_users_description'] = 'All active users who currently have permission to use delegated accounts, including users with no delegation yet.';
$string['manage_historical_users'] = 'Users without permission';
$string['manage_historical_users_description'] = 'Users who retain delegation records but no longer have permission to use delegated accounts. Their history and activity reports remain available for review.';
...
$string['my_delegated_accounts'] = 'My delegated accounts';
$string['my_delegated_accounts_description'] = 'This page lists every active account currently delegated to you. Select an account to start a protected delegated session.';
...
$string['revoke_selected'] = 'Revoke selected';
$string['scheduled_delegations'] = 'Scheduled delegations';
$string['search_authorised_users'] = 'Search authorised users';
$string['select_all_delegations'] = 'Select every revocable delegation on this page';
$string['select_delegation'] = 'Select the delegation for {$a}';
...
$string['use_delegated_account'] = 'Use delegated account: {$a}';
...
$string['view_all_delegated_accounts'] = 'View all delegated accounts';
$string['view_delegated_activity'] = 'View delegated activity';
$string['view_delegation_details'] = 'View delegation details';
