...
$string['delegated_activity_description'] = 'This report shows events recorded by Moodle while {$a->authoriseduser} used the delegated account {$a->delegateduser}. The site log store remains the source of record.';
